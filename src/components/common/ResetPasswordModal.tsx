...
export function ResetPasswordModal({ userId, userFullName, onClose, onSuccess }: ResetPasswordModalProps) {
  ...
  return (
    <div className="user-modal">
      <div className="user-modal__box">
        <p className="user-modal__title">Đặt lại mật khẩu — {userFullName}</p>
