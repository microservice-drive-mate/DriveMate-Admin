...
export function TopicModal({ topics, onClose, onTopicsChanged }: TopicModalProps) {
    ...
    <div className="q-topic-modal">
      <div className="q-topic-modal__box">
        <div className="q-topic-modal__header">
          ...
          <button className="q-topic-modal__close" onClick={onClose}>×</button>
        </div>
        ...
        <div className="q-topic-modal__form">
          ...
          {error && <div className="q-topic-modal__error">{error}</div>}
          ...
          <div className="q-topic-modal__form-actions">
            <button
              ...
              onClick={handleSave}
              disabled={loading}>
              {loading ? "Đang lưu..." : editingTopicId ? "Cập nhật" : "Thêm"}
            </button>
            {editingTopicId && (
              <button className="q-topic-modal__btn" onClick={handleReset} disabled={loading}>
                Hủy sửa
              </button>
            )}
          </div>
