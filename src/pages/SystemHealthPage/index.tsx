		...
		<div className="system-health-page">
			<div className="system-health-page__header">
				<div>
					<h1>System Health</h1>
					<p>
						Monitor service liveness, readiness, dependencies, and
						Prometheus metrics.
					</p>
				</div>
			...
			<div className="system-health-detail-grid">
				<section className="system-health-section">
					<div className="system-health-section__header">
						...
						<StatusBadge
							status={getServiceStatus(selectedSnapshot)}
						/>
					</div>
					...
					{showSelectedHealthSkeleton ? (
						...
						<div className="system-health-detail-list">
							...
							<div>
								<span>Uptime</span>
								<strong>
									{formatDuration(liveReport?.uptimeSeconds)}
								</strong>
							</div>
							<div>
					...
					{showSelectedHealthSkeleton ? (
						<div className="system-health-dependency-list">
							{Array.from({ length: 3 }).map((_, index) => (
								<div
									className="system-health-dependency"
									key={index}
								>
