				...
				<div className="add-ec__form-row">
					<div className="add-ec__form-group">
						...
						<input
							...
							onChange={(e) =>
								onUpdate({
									criticalQuestions: Number(e.target.value),
								})
							}
						/>
						<span className="add-ec__hint">
					...
					<div className="add-ec__form-group">
						...
						<input
							...
							onChange={(e) =>
								onUpdate({
									maxCriticalMistakes: Number(e.target.value),
								})
							}
						/>
						<span className="add-ec__hint">
				...
				<div className="add-ec__form-group">
					<label>
						<input
							...
							onChange={(e) =>
								onUpdate({ shuffleQuestions: e.target.checked })
							}
							style={{ marginRight: 8 }}
						/>
