...
const DAY_OPTIONS: { value: CourseScheduleDayOfWeek; label: string }[] = [
	1, 2, 3, 4, 5, 6, 7,
].map((d) => ({
	value: d as CourseScheduleDayOfWeek,
	label: DAY_OF_WEEK_LABELS[d as CourseScheduleDayOfWeek],
}))
...
export function ScheduleFormModal({
	...
	const handleSave = async () => {
		...
		const res = isEdit
			? await courseService.updateSchedule(
					courseId,
					schedule!.id,
					payload,
				)
