		...
		<div className="audit-page">
			...
			<div className="audit-filters">
				<input
					...
					onChange={(e) =>
						handleFilter({ serviceName: e.target.value })
					}
				...
				<input
					...
					onChange={(e) =>
						handleFilter({ resourceType: e.target.value })
					}
			...
			{logsQuery.error && (
				<div className="audit-page__error">{logsQuery.error}</div>
			)}
					...
					<tbody>
						{logsQuery.loading ? (
							<tr>
								<td
									colSpan={6}
									className="audit-table__loading"
								>
									Đang tải...
								</td>
							</tr>
							...
							logs.map((log) => (
								...
								>
									...
									<td>
										<span
											className={`audit-outcome audit-outcome--${log.outcome.toLowerCase()}`}
										>
											{log.outcome}
										</span>
									</td>
			...
			{selected && (
				<div
					className="audit-detail__overlay"
					onClick={() => {
						setSelected(null)
						setDetailLoading(false)
					}}
				>
					...
					>
						<div className="audit-detail__header">
							<span>
								Chi tiết Audit Log {detailLoading && "..."}
							</span>
							<button
								onClick={() => {
									setSelected(null)
						...
						<div className="audit-detail__body">
							...
							{Object.keys(selected.metadata).length > 0 && (
								<div className="audit-detail__row">
									...
									<pre className="audit-detail__meta">
										{JSON.stringify(
											selected.metadata,
											null,
											2,
