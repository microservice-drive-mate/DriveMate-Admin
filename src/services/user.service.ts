...
export const userService = {
	...
	update: withErrorHandling((id: string, payload: UpdateUserProfilePayload) =>
	...
	setLock: withErrorHandling((id: string, lock: boolean) =>
		apiService.patch<ApiResponse<null>>(`/admin/users/${id}/lock`, {
			lock,
		}),
	),
	...
	addDocument: withErrorHandling(
		(userId: string, payload: AddDocumentPayload) =>
